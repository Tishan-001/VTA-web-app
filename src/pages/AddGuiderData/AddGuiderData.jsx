...
export default function AddGuiderData() {
  return (
    <>
                ...
                <div className="flex sm:flex-col items-center gap-[9px]">
                  <div className="flex flex-col w-[31%] sm:w-full gap-7 sm:p-5">
                    <div className="flex flex-col gap-[18px]">
                      <Heading as="h6" className="text-[20px] mt-[50px]">Your Name</Heading>
                    ...
                    <div className="flex flex-col gap-[18px]">
                      <Heading as="h6" className="text-[20px] mt-[30px]">Type of Guider</Heading>
                      <div>
                        <div>
                          <Text size="s" as="p" className=" w-[220px]">
