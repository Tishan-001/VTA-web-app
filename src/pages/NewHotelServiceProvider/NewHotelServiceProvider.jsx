            ...
            <div className="mb-8 mt-20 rounded-3xl shadow-md">
                <form className="bg-white shadow-2xl rounded-3xl px-8 pt-6 pb-8">
                    ...
                    <div className="flex md:flex-col justify-between items-start gap-4 mt-[-8px]">
                        <Heading size="lg" as="h2">Images</Heading>
                        <div className="flex md:flex-col w-[80%] md:w-full mt-[1px] gap-[5px] md:p-5">
                            ...
                            <FileUpload
                                ...
                                Thumbnail={FileUpload.PreviewItem}
                                onUpload={handleImageUpload}
                                placeholder={() => (<Text as="p">Secondary Image</Text>)}
                                className="flex flex-col items-center w-[700px] h-[120px] gap-[15px] p-[18px] bg-blue_gray-100 rounded-[5px]"
                            >
                            ...
                            >
                                <Text as="p" className="self-center">Secondary Image</Text>
                            </FileUpload>
                            <FileUpload
                                allowMultiple
                                preview
                    ...
                    <div className="mb-10">
                        ...
                        <input className="border-b border-gray-300 w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:border-blue-500" id="whatsapp" type="tel" placeholder="Whatsapp" />
                        <hr className="mt-1 border-t-2 border-gray-300"/>
                    </div>
                    <div className="mb-10">
                        <label className="block text-gray-700 text-2xl font-bold mb-2" htmlFor="email">Email</label>
                        <input className="border-b border-gray-300 w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:border-blue-500" id="email" type="email" placeholder="Email" />
                        <hr className="mt-1 border-t-2 border-gray-300"/>
                    </div>
                    <div className="mb-2">
