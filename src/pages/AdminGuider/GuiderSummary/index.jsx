    ...
    <>
      ...
      <div className="w-full bg-gray-300">
        <div className="flex md:flex-col justify-center items-start">
          ...
          <div className="flex justify-center w-[98%] md:w-full p-9 sm:p-5 bg-gray-100 shadow-xs rounded-[20px]">
            <div className="flex justify-center w-[97%] md:w-full mb-[45px]">
              ...
              <div className="flex md:flex-col justify-between items-start w-full gap-5">
                ...
                <div className="flex flex-col w-[26%] md:w-full mt-3 gap-[58px] sm:gap-[29px]">
                  <Img src="images/img_5_2.png" alt="image" className="h-[325px] object-cover rounded-[20px]" />
                  <div className="flex flex-col md:flex-row gap-[17px]">
                    <div className="flex p-[7px] bg-blue_gray-100 flex-1 rounded-[10px]">
                      <Img
                        src="images/img_eye_2.png"
                        alt="eyetwo_one"
                        className="w-[83px] ml-[31px] md:ml-0 object-cover"
                      />
                    </div>
                    <div className="flex p-[15px] bg-blue_gray-100 flex-1 rounded-[10px]">
                      <Img src="images/img_star_6.svg" alt="image" className="h-[66px] w-[66px] ml-[31px] md:ml-0" />
                    </div>
                  </div>
                </div>
