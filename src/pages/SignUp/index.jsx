...
export default function SignUpPage() {
  return (
    <>
      ...
      <div className="h-[710px] w-full p-[83px] md:p-5 bg-gray-100 relative">
        <div className="flex flex-row md:flex-col justify-center items-center w-max h-max gap-[33px] left-0 bottom-0 right-0 top-0 m-auto md:gap-5 bg-white-A700 shadow-xs absolute rounded-[10px]">
          <Img
            src="images/img_signup_1.png"
            alt="signupone_one"
            className="w-[51%] md:w-full md:h-[544px] rounded-bl-[10px] rounded-tl-[10px] object-cover"
          />
          <div className="flex flex-col items-center justify-start w-[44%] md:w-full">
            ...
            <div className="flex flex-col items-center justify-start w-[90%] md:w-full mt-11 gap-5">
              <Input
                ...
                name="name"
                placeholder="Name"
                className="w-full sm:w-full !text-deep_purple-400_01"
              />
              ...
              >
                <Heading size="md" as="h2" className="!text-white-A700 tracking-[3.60px]">
                  Sign Up
                </Heading>
              </a>
            </div>
        ...
        <div className="flex flex-col items-center justify-start w-[36%] h-max left-[15%] bottom-0 top-0 p-[31px] m-auto sm:p-5 rounded-tl-[10px] rounded-bl-[10px] bg-deep_purple-400_cc absolute">
