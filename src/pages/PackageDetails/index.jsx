  ...
  const tableColumns = React.useMemo(() => {
    ...
    return [
      tableColumnHelper.accessor("place", {
        ...
        header: (info) => (
          <Heading size="s" as="h4" className="p-px !text-black-900_02 ml-[300px] ">
            Place
          </Heading>
        ),
        meta: { width: "88px" },
            ...
            <div className="flex flex-col items-center justify-start w-[92%] md:w-full gap-[141px]">
              ...
              <div className="flex flex-col items-start justify-start w-full gap-[59px]">
                ...
                <table class="shadow-lg bg-white border-collapse">
                  <tr>
                    <th class="bg-blue-100 border text-left px-8 py-4">Place</th>
                  ...
                  <tr class="hover:bg-gray-50">
                    <td class="border px-8 py-4">Temple of Tooth</td>
                    <td class="border px-8 py-4">Day 01</td>
                    <td class="border px-8 py-4">Hilton Hotel in Nuwara</td>
                    <td class="border px-8 py-4">There are very relaable weather and cold and so on.</td>
                  </tr>
                  <tr class="hover:bg-gray-50">
                    <td class="border px-8 py-4">Temple of Tooth</td>
                    <td class="border px-8 py-4">Day 01</td>
              ...
              <div className="flex flex-col items-start justify-start w-full gap-[59px]">
                ...
                <table class="shadow-lg bg-white border-collapse">
                  <tr>
                    ...
                    <th class="bg-blue-100 border text-center px-8 py-4">BASICS</th>
                    <th class="bg-blue-100 border text-center px-8 py-4">STANDARD</th>
                    <th class="bg-blue-100 border text-center px-8 py-4">PREMIUM</th>
                  </tr>
                  <tr class="hover:bg-gray-50">
                    <td class="border px-8 py-4">Include Welcome Drink</td>
                    <td class="border text-center px-8 py-4">Yes</td>
                    <td class="border text-center px-8 py-4">Yes</td>
                    <td class="border text-center px-8 py-4">Yes</td>
                  </tr>
                  <tr class="hover:bg-gray-50">
                    <td class="border px-8 py-4">Include Foods</td>
                    <td class="border text-center px-8 py-4">No</td>
                    <td class="border text-center px-8 py-4">Yes</td>
                    <td class="border text-center px-8 py-4">Yes</td>
                  </tr>
                  <tr class="hover:bg-gray-50">
                    <td class="border px-8 py-4">Air Condition</td>
                    <td class="border text-center px-8 py-4">No</td>
                    <td class="border text-center px-8 py-4">Yes</td>
                    <td class="border text-center px-8 py-4">Yes</td>
                  </tr>
                  <tr class="hover:bg-gray-50">
                    <td class="border px-8 py-4">Free wifi</td>
                    <td class="border text-center px-8 py-4">No</td>
                    <td class="border text-center px-8 py-4">No</td>
                    <td class="border text-center px-8 py-4">Yes</td>
                  </tr>
                  <tr class="hover:bg-gray-50">
                    <td class="border px-8 py-4">Pool Access</td>
                    <td class="border text-center px-8 py-4">No</td>
                    <td class="border text-center px-8 py-4">No</td>
                    <td class="border text-center px-8 py-4">Yes</td>
                  </tr>
                  <tr class="hover:bg-gray-50">
                    <td class="border px-8 py-4">Hot Water Access</td>
                    <td class="border text-center px-8 py-4">No</td>
                    <td class="border text-center px-8 py-4">No</td>
                    <td class="border text-center px-8 py-4">Yes</td>
                  </tr>
                  <tr class="hover:bg-gray-50">
                    <td class="border px-8 py-4">Price</td>
                    <td class="border text-center px-8 py-4">100$</td>
                    <td class="border text-center px-8 py-4">200$</td>
                    <td class="border text-center px-8 py-4">300$</td>
                  </tr>
                  <tr class="hover:bg-gray-50">
                    <td class="border px-8 py-4"></td>
                    <td class="border text-center px-8 py-4"><button className="bg-green-500 pl-[40px] pr-[40px] pt-[10px] pb-[10px] rounded-lg">Pay Now</button></td>
                    <td class="border text-center px-8 py-4"><button className="bg-green-500 pl-[40px] pr-[40px] pt-[10px] pb-[10px] rounded-lg">Pay Now</button></td>
                    <td class="border text-center px-8 py-4"><button className="bg-green-500 pl-[40px] pr-[40px] pt-[10px] pb-[10px] rounded-lg">Pay Now</button></td>
                  </tr>
                </table>
