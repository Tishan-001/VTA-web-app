...
export default function TaxiDetail() {
  return (
    <>
      ...
      <Heading size="3xl" as="h2" className="mt-[100px] ml-[81px] md:ml-5 !text-black-900_02">
          Doctors
        </Heading>


      <div className="md:gap-5  gap-[91px] grid sm:grid-cols-1 md:grid-cols-2 grid-cols-3 justify-center min-h-[auto] mt-[100px] w-[76%] ml-[200px] md:w-full md:ml-auto  ">
        ...
        <Footer className="bg-black-900_01 flex mt-[20px] items-center justify-center md:px-5 w-full" />
    </>
  );
}
