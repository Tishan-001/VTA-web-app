...
export default function AddVehicalPricing() {
  return (
    <>
      <Helmet>
          ...
          <div className="flex flex-col gap-9">
            ...
            <div className="flex flex-col items-center w-[45%] md:w-full md:ml-0 mx-auto">
              ...
              <table className="w-[900px] h-[700px] mx-auto mt-10">
                ...
                <tbody>
                  <tr>
                    <td class="pl-[10px] align-bottom pb-[10px] border border-slate-700 ...">Include Driver</td>
                  ...
                  <tr>
                    ...
                    <td class="border border-slate-700 ...">
                      <input type="number" className="ml-10 mb-3" placeholder="km" />
                      <div className="self-stretch h-px opacity-30 bg-black-900_cc w-[180px] mx-auto" />
                    </td>
                    <td class="border border-slate-700 ...">
                      <input type="number" className="ml-10 mb-3" placeholder="km" />
                    ...
                    <td class="border border-slate-700 ...">
                      <input type="number" className="ml-10 mb-3" placeholder="L" />
                      <div className="self-stretch h-px opacity-30 bg-black-900_cc w-[180px] mx-auto" />
                    </td>
                  </tr>
                  <tr>
                    <td class="pl-[10px] align-bottom pb-[10px] border border-slate-700 ...">Maximum Distance</td>
                    <td class="border border-slate-700 ...">
                      <input type="number" className="ml-10 mb-3" placeholder="Liter" />
                      <div className="self-stretch h-px opacity-30 bg-black-900_cc w-[180px] mx-auto" />
                    </td>
                    <td class="border border-slate-700 ...">
                      <input type="number" className="ml-10 mb-3" placeholder="Liter" />
                  ...
                  <tr>
                    <td class="pl-[10px] align-bottom pb-[10px] border border-slate-700 ...">Fuel Capacity</td>
                    <td class="border border-slate-700 ...">
                      <input type="number" className="ml-10 mb-3" placeholder="Liter" />
                      <div className="self-stretch h-px opacity-30 bg-black-900_cc w-[180px] mx-auto" />
                    </td>
                  ...
                  <tr>
                    <td class="pl-[10px] align-bottom pb-[10px] border border-slate-700 ...">Storage Capacity</td>
                    <td class="border border-slate-700 ...">
