      ...
      <div className="flex flex-col items-center justify-start w-full">
        <div className="flex flex-col items-center justify-start w-full bg-white-A700">
          <div className="flex flex-col items-center justify-start w-full mt-[21px]">
                ...
                <div className="flex flex-row justify-start w-[71%] mt-[25px] ml-[58px]">
                  <div className="flex flex-col items-start justify-start w-full">
                    ...
                    <div className="flex flex-row justify-start items-center mt-[17px] gap-[18px]">
                      <Img src="images/img_image_64.png" alt="imagesixtyfour" className="w-5 object-cover" />
                    ...
                    <div className="flex flex-row justify-start items-center gap-[13px]">
                      <Img src="images/img_image_65.png" alt="imagesixtyfive" className="w-[25px] object-cover" />
                    ...
                    <div className="flex flex-row justify-start items-center mt-[13px] gap-3.5">
                      <Img src="images/img_image_66.png" alt="imagesixtysix" className="w-[23px] object-cover" />
                    ...
                    <div className="flex flex-row justify-start w-full mt-[15px] gap-[7px]">
                      ...
                      <div className="flex flex-row justify-evenly items-center w-[19%] gap-2.5 py-[5px] border-green-900_cc border border-solid bg-green-900_33 rounded-[10px]">
                        <Img src="images/img_city_1.png" alt="cityone_one" className="w-[19px] object-cover" />
                        <Text size="xl" as="p" className="mt-0.5 !font-normal">
                          City view
                        </Text>
                      </div>
                      ...
                      <div className="flex flex-row justify-evenly items-center w-[28%] gap-[9px] py-1.5 border-green-900_cc border border-solid bg-green-900_33 rounded-[10px]">
                        <Img src="images/img_shower_1.png" alt="showerone_one" className="w-[22px] object-cover" />
                        <Text size="xl" as="p" className="!font-normal">
                          Attach Bathroom{" "}
                        </Text>
                      </div>
                      ...
                      <div className="flex flex-row justify-center items-center w-1/4 p-[5px] border-green-900_cc border border-solid bg-green-900_33 rounded-[10px]">
                        <Img
                          src="images/img_soundproof_1.png"
                          alt="soundproofone"
                    ...
                    <div className="flex flex-col w-[34%] mt-4 mb-[35px] ml-[66px] pb-1 gap-px">
                      ...
                      <div className="flex flex-row gap-[13px] items-start justify-start mt-[15px] w-[79%] md:w-full">
                             ...
                             <div className="flex flex-row justify-start items-center mt-[13px] gap-3.5   ">
                                 ...
                                 <Img src="images/img_sofa_bed_1.png" alt="imagesixtysix" className="w-[23px] object-cover" />
                             </div>
                      ...
                      <div className="flex flex-row gap-[13px] items-start justify-start mt-[15px] w-[79%] md:w-full">
                             ...
                             <div className="flex flex-row justify-start items-center mt-[13px] gap-3.5   ">
                                 ...
                                 <Img src="images/img_double_bed_1.png" alt="imagesixtysix" className="w-[23px] object-cover" />
                             </div>
              ...
              <div className="flex flex-row justify-center w-full p-5 border-blue_gray-100 border-2 border-solid rounded-[30px]">
                <div className="flex flex-col items-center justify-start w-[99%] mt-[23px] mr-[5px] gap-6">
                  <div className="flex flex-row justify-between items-start w-[92%]">
                    ...
                    <div className="flex flex-col items-start justify-start w-[81%] mb-3">
                      ...
                      <div className="flex flex-row justify-start items-center w-[42%] mt-[29px] gap-5">
                       <input type="checkbox" className="h-[25px] w-[25px] border border-gray-400 border-4 border-solid text-left rounded-[50%]" checked={carRent} onChange={toggleCarRent} />
                        <Text size="xl" as="p">
                    ...
                    <Img
                      src="images/img_electric_car_1.png"
                      alt="electriccarone"
                  ...
                  <div className="flex flex-row justify-between items-start w-[92%]">
                    ...
                    <Img src="images/img_taxi_1.png" alt="taxione_one" className="w-[110px] object-cover" />
                  </div>
                </div>
                ...
                <div className="flex flex-row justify-start w-full p-[29px] border-blue_gray-100 border-2 border-solid rounded-[30px]">
                  <div className="flex flex-col items-start justify-start w-[59%] mb-[11px] ml-12">
                    ...
                    <div className="flex flex-row justify-start items-center mt-[33px] gap-[17px]">
                      <Img src="images/img_image_64.png" alt="image" className="w-5 object-cover" />
                      <Text size="xl" as="p" className="!font-normal">
                    ...
                    <div className="flex flex-row justify-start items-center mt-[13px] gap-[22px]">
                      <Img src="images/img_calendar_1.png" alt="image_one" className="w-[26px] object-cover" />
            ...
            <footer className="flex justify-center items-center w-full mt-[87px] pl-14 pr-[97px] py-[97px] bg-black-900_01">
              <div className="flex flex-row justify-center w-full mx-auto max-w-[1048px]">
                <div className="flex flex-row justify-between items-center w-full">
                  <div className="flex flex-col items-start justify-start mt-0.5 gap-[31px]">
                    <a href="#">
                      <Text size="md" as="h4" className="!text-white-A700">
                        Company
                      </Text>
                    </a>
                  ...
                  <div className="flex flex-row justify-between items-start w-[72%]">
                    <div className="flex flex-col items-start justify-start mt-[3px] gap-[30px]">
                      <a href="#">
                        <Text size="md" as="h4" className="!text-white-A700">
                          Contact Us
                        </Text>
                      </a>
                      <ul className="flex flex-col items-start justify-start ml-[3px] gap-7">
                        <li>
                          <a href="#">
                    ...
                    <div className="flex flex-row justify-center w-1/4">
                      <div className="flex flex-col items-end justify-start w-full">
                        <div className="flex flex-row justify-end w-[83%] mr-1 z-[1]">
                          <a href="#">
                            <Text size="md" as="h4" className="!text-white-A700">
                              Social Share
                            </Text>
                        ...
                        <div className="flex flex-row justify-end items-start w-full mt-[-12px]">
                          <div className="flex flex-row justify-end items-center w-[70%]">
                            <Img src="images/img_facebook.png" alt="facebook_one" className="w-[101px] object-cover" />
                            <Button size="sm" className="w-[39%] ml-[-23px]">
                              <Img src="images/img_instagram.png" />
                            </Button>
                          </div>
                          <Button size="lg" className="w-[58px] mt-[19px] ml-[-2px]">
