              ...
              <div className="flex flex-col w-full p-7 sm:p-5 bg-gray-100 shadow-xs rounded-[20px]">
                ...
                <div className="gap-9 grid-cols-3 md:grid-cols-[1fr] grid">
                  <div className="flex w-full bg-blue_gray-100 rounded-[10px]">
                    <div className="w-full p-[13px] bg-blue_gray-600 rounded-[10px]">
                  ...
                  <div className="flex w-full p-[13px] bg-blue_gray-600 rounded-[10px]">
                  ...
                  <div className="flex justify-center w-full p-[13px] bg-blue_gray-600 rounded-[10px]">
                ...
                <Heading size="xl" as="h5" className="mt-[41px] ml-[9px]">
